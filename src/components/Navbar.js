...
// export default function Navbar({ path }) {
//   let [navTextColor, setNavTextColor] = useState("white")
//   // let [logo, setLogo] = useState(logoWhite)
...
//   // changes logo path/variable based on what the nav text color should be
//   // useEffect(() => {
//   //   navTextColor === "white" ? setLogo(logoWhite) : setLogo(logoBlack)
//   // }, [navTextColor])

//   const data = useStaticQuery(graphql`
//     query NavBarLogoBlack {
//       file(relativePath: {eq: "logo-black.webp"}) {
//         id
//         childImageSharp {
//           gatsbyImageData(width: 60, placeholder: DOMINANT_COLOR)
//         }
//       }
//     }
//     query NavBarLogoWhite {
...
//   const logoBlack = getImage(data.file)
