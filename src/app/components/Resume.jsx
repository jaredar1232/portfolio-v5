    ...
    <div className="text-white pt-0 pb-10 md:pb-8">
      <div className="w-full max-w-52 h-auto mx-auto">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex justify-center items-center w-full h-full font-normal uppercase text-xl md:text-lg text-customBlueDark bg-white text-center py-4 px-1 md:py-2 rounded-md transition-shadow duration-300 no-underline hover:bg-gradient-to-r hover:from-customBlue hover:to-customBlueDark hover:text-white hover:shadow-lg whitespace-nowrap"
        >
          <svg
